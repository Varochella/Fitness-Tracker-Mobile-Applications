                      ...
                      titlesData: FlTitlesData(
                        ...
                        bottomTitles: AxisTitles(
                          axisNameWidget: Center(
                            child: Text("Date", style: GoogleFonts.montserrat(textStyle: TextStyle(fontSize: 14, fontWeight: FontWeight.bold),),
                            ),
                          ),
                          sideTitles: SideTitles(
                            showTitles: true,
                        ...
                        leftTitles: AxisTitles( 
                          axisNameWidget: Align(
                            ...
                            child: Text("Water", style: GoogleFonts.montserrat(textStyle: TextStyle(fontSize: 14, fontWeight: FontWeight.bold),),
                            ),
                          ),
                        ),
                      ),
          ...
          children: [
            Expanded(
              child: ElevatedButton.icon(
                ...
                label: Text("STEPS", style: GoogleFonts.alegreya(textStyle: TextStyle(fontSize: 15),),),
              ),
            ),
            ...
            Expanded(
              child: ElevatedButton.icon(
                ...
                label: Text("WATER", style: GoogleFonts.alegreya(textStyle: TextStyle(fontSize: 15),),
                ),
              ),
            ),
          ],
          ...
          children: [
            ...
            Row( 
              ...
              children: [ 
                ...
                child: Text("ADD", style: GoogleFonts.alegreya(textStyle: TextStyle(fontSize: 15),),
                ),
              ),
              ElevatedButton(
                style: ElevatedButton.styleFrom( 
                ...
                child: Text("CHANGE", style: GoogleFonts.alegreya(textStyle: TextStyle(fontSize: 15),),
                ),
              ),
              ElevatedButton(
                style: ElevatedButton.styleFrom( 
                ...
                child: Text("DELETE", style: GoogleFonts.alegreya(textStyle: TextStyle(fontSize: 15),),
                ),
              ),
            ],
          ),
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return Card(
                    ...
                    elevation: 4,
                    child: ListTile(
                      title: Text("Date: $date", style: GoogleFonts.merriweather(textStyle: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.black),),
                      ),
                      subtitle: Text("Steps: $steps",style: GoogleFonts.merriweather(textStyle: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.black),),
                      ),
          ...
          children: [
            Expanded(
              child: ElevatedButton.icon(
                ...
                label: Text("HOME", style: GoogleFonts.alegreya(textStyle: TextStyle(fontSize: 15),),
                ),
              ),
            ),
            const SizedBox(width: 8),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            Text("DATE", style: GoogleFonts.alegreya(textStyle: TextStyle(fontSize: 25, fontWeight: FontWeight.bold),),
            ),
            TextField(
              controller: _dateController,
            ...
            ElevatedButton(
              style: ElevatedButton.styleFrom( 
                ...
                child: Text("Submit",style: GoogleFonts.merriweather(textStyle: TextStyle(fontSize: 15),),
                ),
                ),
            const SizedBox(height: 20),
            Expanded(
                ...
                itemBuilder: (context, index) {
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      ...
                      subtitle: Text("Water: $water Liter", style: GoogleFonts.merriweather(textStyle: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.black),),
                      ),
